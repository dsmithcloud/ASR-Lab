...
Invoke-WebRequest -Uri "https://github.com/dsmithcloud/ASR-Lab/blob/main/MODULES/VIRTUALMACHINE/asrdemo.png" -OutFile "${defaultSitePath}\asrdemo.png"
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/dsmithcloud/ASR-Lab/refs/heads/main/MODULES/VIRTUALMACHINE/update-htmlcontent.ps1" -OutFile "${defaultSitePath}\update-htmlcontent.ps1"
